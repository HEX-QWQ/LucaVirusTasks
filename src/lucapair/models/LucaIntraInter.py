...
class LucaIntraInter(BertPreTrainedModel):
    def __init__(self, config, args):
        super(LucaIntraInter, self).__init__(config)
    ...
    def forward(
        ...
        if self.pooler is not None:
            last_hidden_states = [
                ...
                # ab
                self.pooler[2](last_hidden_states[2], seq_attention_masks_a),
                # ba
                self.pooler[3](last_hidden_states[3], seq_attention_masks_b)
            ]
