...
python run.py \
  ...
  --vector_dirpath /mnt2/sanyuan.hy/vectors/DeepAbBindv2/$llm_type/$llm_version/$llm_step \
  --matrix_dirpath /mnt2/sanyuan.hy/matrices/DeepAbBindv2/$llm_type/$llm_version/$llm_step \
  --seq_fc_size null \
