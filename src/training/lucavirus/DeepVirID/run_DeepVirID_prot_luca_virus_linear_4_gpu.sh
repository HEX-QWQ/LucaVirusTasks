...
# for dataset
DATASET_NAME="DeepVirID_4_gpu"
DATASET_TYPE="protein"

# for task
TASK_TYPE="binary_class"
TASK_LEVEL_TYPE="seq_level"
LABEL_TYPE="DeepVirID"
...
cd ../../../
python -W ignore -m torch.distributed.launch --nnodes 1 --node_rank 0 --master_port=25688 --nproc_per_node=4 \
  run.py \
  ...
  --test_data_dir ../dataset/$DATASET_NAME/$DATASET_TYPE/$TASK_TYPE/test/#../dataset/$DATASET_NAME/$DATASET_TYPE/$TASK_TYPE/independent_test/ \
  ...
  --vector_dirpath /mnt/sanyuan.hy/vectors/$DATASET_NAME/$DATASET_TYPE/$TASK_TYPE/$llm_type/$llm_version/$llm_time_str/$llm_step \
  --matrix_dirpath /mnt/sanyuan.hy/matrices/$DATASET_NAME/$DATASET_TYPE/$TASK_TYPE/$llm_type/$llm_version/$llm_time_str/$llm_step \
  --seq_fc_size null \
