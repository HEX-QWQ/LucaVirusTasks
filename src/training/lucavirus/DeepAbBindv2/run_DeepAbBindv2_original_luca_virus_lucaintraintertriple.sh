...
# for model
MODEL_TYPE="lucaintraintertriple"
CONFIG_NAME="lucaintraintertriple_config.json"
FUSION_TYPE="concat"
dropout_prob=0.1
fc_size=512
classifier_size=128
...
python run.py \
  ...
  --vector_dirpath /mnt2/sanyuan.hy/vectors/DeepAbBindv2/$llm_type/$llm_version/$llm_time_str/$llm_step \
  --matrix_dirpath /mnt2/sanyuan.hy/matrices/DeepAbBindv2/$llm_type/$llm_version/$llm_time_str/$llm_step \
  --seq_fc_size null \
