...
@file: LucaTriple1
@desc: LucaTriple1 for homogeneous three sequences
'''
...
class LucaTriple1(BertPreTrainedModel):
    def __init__(self, config, args):
        super(LucaTriple1, self).__init__(config)
        # seq, matrix, vector, seq+matrix, seq+vector
        if config.seq_max_length is None and config.seq_max_length_a == config.seq_max_length_b == config.seq_max_length_c:
            config.seq_max_length = config.seq_max_length_a
        if config.matrix_max_length is None and config.matrix_max_length_a == config.matrix_max_length_b == config.matrix_max_length_c:
            config.matrix_max_length = config.matrix_max_length_a
        if config.embedding_input_size is None and config.embedding_input_size_a == config.embedding_input_size_b == config.embedding_input_size_c:
        ...
        last_hidden_size = last_hidden_size * 3
